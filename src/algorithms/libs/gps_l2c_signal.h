...
//! Generates complex GPS L2C L code for the desired SV ID
void gps_l2c_l_code_gen_complex(std::complex<float>* _dest, unsigned int _prn);

//! Generates complex GPS L2C L code for the desired SV ID, and sampled to specific sampling frequency
void gps_l2c_l_code_gen_complex_sampled(std::complex<float>* _dest, unsigned int _prn, signed int _fs);
